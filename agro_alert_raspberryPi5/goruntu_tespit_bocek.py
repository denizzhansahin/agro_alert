...
def goruntu_Tahmin(goruntu_yol):
    ...
    for result in results:
        ...
        gozlem_data = {
            ...
            "gozlem_tipi": "bocek_tespiti",
            "sayisal_deger": len(result.boxes.cls),  # Number of detected objects
            "metin_deger": "bocek",  # Optional, set to None
...
def goruntu_tespit_bocek():
    ...
    picam2.start_and_capture_file(os.getcwd() + veri_yol + "/" +"bocek_image{}.jpg".format(Veri.counter))
    #kamera kapatma
    picam2.close()
    ...
    #tahmin yapma
    returns = goruntu_Tahmin(os.getcwd() + veri_yol + "/" +"bocek_image{}.jpg".format(Veri.counter))
    ...
    veri_yol_dosya = os.getcwd() + veri_yol + "/" + "bocek_image{}.jpg".format(Veri.counter)
